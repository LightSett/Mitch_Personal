...
class PDFExporter(object):
    ...
    def getParameterInfo(self):
        ...
        pd_cd.value = "CD_Cloudwyze"
        pd_cd.filter.list = ["PD", "CD",  "CD_Cloudwyze", "Custom"]
    ...
    def updateParameters(self, parameters):
        ...
        elif parameters[7].value == "CD_Cloudwyze" and self.cd_check:
            parameters[0].value = self.cd_Cloudwyze_order
            parameters[4].value = None
            if parameters[2].value.__contains__("_PD") or parameters[2].value.__contains__("_CD"):
                parameters[2].value = parameters[2].value.replace("_PD", "_CD")
            else:
